...
<body class="bg-animated min-h-screen flex items-center justify-center p-4 lg:p-12 relative antialiased">
    ...
    <div class="w-full max-w-3xl glass-panel rounded-[2.5rem] overflow-hidden relative z-10 shadow-[0_32px_64px_-15px_rgba(0,0,0,0.3)] border border-white/40">
        ...
        <div class="w-full p-8 sm:p-12 lg:p-14 flex flex-col relative bg-white/95 backdrop-blur-md custom-scrollbar overflow-y-auto max-h-[90vh]">
            ...
            {{-- BACK BUTTON --}}
            <a href="{{ route('home') }}" class="absolute top-8 left-8 w-10 h-10 bg-slate-100 hover:bg-slate-200 text-slate-500 rounded-xl flex items-center justify-center transition-all duration-300 group shadow-sm">
            ...
            <div class="mb-10 text-center">
                ...
                <div class="mt-4 inline-block px-4 py-2 bg-blue-50/50 rounded-full border border-blue-100/50">
                    <p class="text-[11px] text-blue-600 font-bold tracking-wide uppercase">
                        ...
                        <a href="{{ route('login', ['as' => 'mitra']) }}" class="text-blue-700 hover:underline ml-1 font-extrabold">Masuk Sekarang</a>
                    </p>
                </div>
            </div>
            ...
            <form method="POST" action="{{ route('mitra.register.submit') }}" class="space-y-8">
                @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            ...
                            <div class="relative group">
                                ...
                                <input type="text" name="name" required autofocus class="w-full pl-11 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl text-slate-800 text-sm font-semibold outline-none transition-all duration-300 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10" placeholder="Nama Pengelola" value="{{ old('name') }}">
                            </div>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative group">
                                ...
                                <input type="email" name="email" required class="w-full pl-11 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl text-slate-800 text-sm font-semibold outline-none transition-all duration-300 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10" placeholder="email@bisnis.com" value="{{ old('email') }}">
                            </div>
                        </div>
                        ...
                        <div class="space-y-2 md:col-span-2">
                            ...
                            <div class="relative group">
                                ...
                                <input type="text" name="no_hp" required class="w-full pl-11 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl text-slate-800 text-sm font-semibold outline-none transition-all duration-300 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10" placeholder="Contoh: 081234567890" value="{{ old('no_hp') }}">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            ...
                            <div class="relative group">
                                ...
                                <input type="text" name="nama_rental" required class="w-full pl-11 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl text-slate-800 text-sm font-semibold outline-none transition-all duration-300 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10" placeholder="Contoh: Berkah Jaya Rent" value="{{ old('nama_rental') }}">
                            </div>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative group">
                                ...
                                <input type="text" name="nama_cabang" required class="w-full pl-11 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl text-slate-800 text-sm font-semibold outline-none transition-all duration-300 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10" placeholder="Contoh: Cabang Kota" value="{{ old('nama_cabang') }}">
                            </div>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative group">
                                ...
                                <input type="text" name="kota" required class="w-full pl-11 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl text-slate-800 text-sm font-semibold outline-none transition-all duration-300 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10" placeholder="Pekanbaru, Jakarta, dll" value="{{ old('kota') }}">
                            </div>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative group">
                                ...
                                <input type="text" name="nomor_telepon_cabang" required class="w-full pl-11 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl text-slate-800 text-sm font-semibold outline-none transition-all duration-300 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10" placeholder="Nomor Kantor" value="{{ old('nomor_telepon_cabang') }}">
                            </div>
                        </div>
