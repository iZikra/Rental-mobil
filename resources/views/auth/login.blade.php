        ...
        <div class="w-full p-8 sm:p-12 lg:p-16 flex flex-col justify-center relative bg-white">
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative group">
                        ...
                        <input type="email" name="email" required autofocus
                               ...
                               placeholder="emailanda@contoh.com" value="{{ old('email') }}">
                    </div>
                </div>
                ...
                <div class="flex items-center justify-between pt-2">
                    ...
                    <a href="{{ route('password.request') }}" class="text-sm font-bold text-blue-600 hover:text-blue-700 hover:underline transition">Lupa Sandi?</a>
                </div>
            ...
            <div class="mt-8 text-center bg-slate-50 border border-slate-100 rounded-2xl p-4">
                ...
                <div class="mt-2 flex flex-col sm:flex-row justify-center gap-3 items-center text-sm font-bold">
                    <a href="{{ route('register') }}" class="text-blue-600 hover:text-blue-800 hover:underline flex items-center gap-1">
                        <i class="fa-regular fa-user"></i> Daftar Customer
                    </a>
                    <span class="hidden sm:inline text-slate-300">|</span>
                    <a href="{{ route('mitra.register') }}" class="text-slate-700 hover:text-blue-600 hover:underline flex items-center gap-1">
