                ...
                <div class="md:col-span-1 space-y-6">
                    <div class="bg-white rounded-3xl shadow-sm border border-slate-100 p-6 overflow-hidden relative group">
                        ...
                        <div class="relative z-10">
                            ...
                            @if($folderName)
                            <form action="{{ route('mitra.rag.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
                                @csrf
                                <div>
                    ...
                    <div class="bg-sky-50 rounded-3xl p-6 border border-sky-100">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                <h4 class="text-sm font-bold text-sky-900">Folder Data Anda: <span class="bg-sky-200 text-sky-800 px-1.5 py-0.5 rounded ml-1">{{ $folderName ?? 'Kosong' }}</span></h4>
                ...
                <div class="md:col-span-2">
                    <div class="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden h-full">
                        <div class="p-6 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
                            ...
                            <span class="bg-blue-100 text-blue-700 text-xs font-bold px-3 py-1 rounded-full">{{ count($files) }} Dokumen</span>
                        </div>
                        <div class="p-0">
                                ...
                                <tbody class="divide-y divide-slate-50">
                                    ...
                                    <tr class="hover:bg-slate-50 transition duration-150 group">
                                        ...
                                        <td class="px-6 py-4 text-center">
                                            <form action="{{ route('mitra.rag.destroy', $file['name']) }}" method="POST" onsubmit="return confirm('Anda yakin ingin mencabut file kebijakan ini dari Chatbot AI?');">
                                                @csrf
                                                @method('DELETE')
