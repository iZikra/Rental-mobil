                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="col-span-2 md:col-span-1 border-l-4 border-blue-500 pl-4 bg-blue-50 py-2 rounded-r-md">
                                ...
                                <select name="tipe_mobil" class="w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200" required>
                                    <option value="City Car" <?php echo e($mobil->tipe_mobil == 'City Car' ? 'selected' : ''); ?>>City Car</option>
                                    <option value="Compact MPV" <?php echo e($mobil->tipe_mobil == 'Compact MPV' ? 'selected' : ''); ?>>Compact MPV</option>
                                    <option value="Luxury Sedan" <?php echo e($mobil->tipe_mobil == 'Luxury Sedan' ? 'selected' : ''); ?>>Luxury Sedan</option>
                                    <option value="Mini MPV" <?php echo e($mobil->tipe_mobil == 'Mini MPV' ? 'selected' : ''); ?>>Mini MPV</option>
                                    <option value="Minibus" <?php echo e($mobil->tipe_mobil == 'Minibus' ? 'selected' : ''); ?>>Minibus</option>
                                    <option value="Minivan" <?php echo e($mobil->tipe_mobil == 'Minivan' ? 'selected' : ''); ?>>Minivan</option>
                                    <option value="SUV" <?php echo e($mobil->tipe_mobil == 'SUV' ? 'selected' : ''); ?>>SUV</option>
                                    <option value="Sedan" <?php echo e($mobil->tipe_mobil == 'Sedan' ? 'selected' : ''); ?>>Sedan</option>
                                </select>
                            </div>
                            ...
                            <div class="col-span-2 border border-gray-200 p-4 rounded-md bg-gray-50 flex items-center gap-4">
                                ...
                                <div class="w-32 h-24 bg-white border border-gray-300 rounded flex items-center justify-center overflow-hidden">
                                    <img src="<?php echo e($mobil->image_url); ?>" alt="Foto Lama" class="w-full h-full object-contain" onerror="this.src='https://placehold.co/150x100?text=Tanpa+Foto'">
                                </div>
                                <div class="flex-1">
...
<?php endif; ?>
<?php /**PATH C:\Users\GF 63\rental-mobil\resources\views/mitra/mobil/edit.blade.php ENDPATH**/ ?>