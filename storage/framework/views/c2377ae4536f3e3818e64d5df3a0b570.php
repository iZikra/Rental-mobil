...
<?php $component->withAttributes([]); ?>
    ...
    <div>
        ...
        <div id="jemput_lain_wrap" class="mt-3 <?php echo e(old('lokasi_ambil') == 'lainnya' ? '' : 'hidden'); ?>">
            ...
            <textarea name="alamat_jemput_lain" rows="2" class="w-full bg-white border border-gray-300 rounded-xl px-4 py-3 focus:ring-blue-500 focus:border-blue-500 font-semibold text-gray-700" placeholder="Tulis alamat lengkap penjemputan"><?php echo e(old('alamat_jemput_lain')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div>
        ...
        <div id="antar_lain_wrap" class="mt-3 <?php echo e(old('lokasi_kembali') == 'lainnya' ? '' : 'hidden'); ?>">
            ...
            <textarea name="alamat_antar_lain" rows="2" class="w-full bg-white border border-gray-300 rounded-xl px-4 py-3 focus:ring-blue-500 focus:border-blue-500 font-semibold text-gray-700" placeholder="Tulis alamat lengkap pengembalian"><?php echo e(old('alamat_antar_lain')); ?></textarea>
        ...
        document.getElementById('bookingForm').addEventListener('submit', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "<?php echo e(route('login')); ?>?redirect=<?php echo e(urlencode(route('pages.order'))); ?>";
                }
            });
            return false;
            <?php else: ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\GF 63\rental-mobil\resources\views/pages/order.blade.php ENDPATH**/ ?>