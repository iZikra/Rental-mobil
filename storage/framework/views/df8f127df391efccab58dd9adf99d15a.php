...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            <h2 class="font-bold text-2xl text-gray-800 leading-tight">
                <?php echo e(__('Daftar Pesanan Masuk')); ?>
    ...
    <tr class="hover:bg-gray-50 transition duration-200 group">
            ...
            <div class="flex flex-col gap-3 text-xs">
                ...
                <div class="relative pl-4 border-l-2 border-indigo-400">
                    ...
                    <p class="font-bold text-gray-800">
                        <?php echo e($t->lokasi_jemput ?? 'Di Kantor FZ Rent'); ?>

                    </p>
                    <span class="text-[10px] text-gray-400">
                        <?php echo e(\Carbon\Carbon::parse($t->tgl_ambil)->format('d M, H:i')); ?>
                ...
                <div class="relative pl-4 border-l-2 border-green-400">
                    ...
                    <p class="font-bold text-gray-800">
                        <?php echo e($t->lokasi_kembali ?? ($t->lokasi_jemput ?? 'Di Kantor FZ Rent')); ?>

                    </p>
                    <span class="text-[10px] text-gray-400">
                        <?php echo e(\Carbon\Carbon::parse($t->tgl_kembali)->format('d M, H:i')); ?>
        ...
        <td class="px-6 py-4 text-center whitespace-nowrap">
            ...
            <?php if($fotoIdentitas): ?>
                ...
                <div class="flex flex-col items-center gap-2">
                    <img src="<?php echo e($urlIdentitas); ?>" 
                            ...
                            onclick="window.open('<?php echo e($urlIdentitas); ?>', '_blank')">
                    
                    <a href="<?php echo e($urlIdentitas); ?>" target="_blank" class="text-[10px] text-blue-600 hover:underline">
                        Lihat
                    </a>
                </div>
            <?php else: ?>
        ...
        <td class="px-6 py-4 text-center">
            ...
            <?php if(in_array($status, ['pending', 'menunggu_pembayaran', 'menunggu'])): ?>
            ...
            <?php elseif(in_array($status, ['approved', 'disetujui', 'process', 'disewa', 'sedang_disewa'])): ?>
            ...
            <?php elseif(in_array($status, ['finished', 'selesai'])): ?>
...
<?php endif; ?><?php /**PATH C:\Users\GF 63\rental-mobil\resources\views/admin/transaksi/index.blade.php ENDPATH**/ ?>