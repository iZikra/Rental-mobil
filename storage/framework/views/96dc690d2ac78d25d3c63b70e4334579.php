     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between items-center">
            <h2 class="font-bold text-2xl text-gray-800 leading-tight tracking-tight">
                <?php echo e(__('Manajemen Pesanan')); ?>
                                    ...
                                    <td class="px-6 py-5 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="h-10 w-10 flex-shrink-0 bg-blue-600 rounded-full flex items-center justify-center text-white font-bold">
                                                <?php echo e(substr($p->nama, 0, 1)); ?>

                                            </div>
                                            <div class="ml-4">
                                                <div class="text-sm font-black text-gray-900"><?php echo e($p->nama); ?></div>
...
<td class="px-6 py-5 whitespace-nowrap">
    <?php if($p->mobil): ?>
        <div class="text-sm font-black text-gray-800 uppercase">
            ...
            <?php echo e($p->mobil->nama_mobil ?? $p->mobil->nama ?? $p->mobil->merk ?? 'NAMA TIDAK ADA'); ?>
        ...
        <div class="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold bg-blue-50 text-blue-700 border border-blue-200 uppercase tracking-tighter mt-1">
            ...
            <?php echo e($p->mobil->nopol ?? $p->mobil->no_plat ?? $p->mobil->plat_nomor ?? 'PLAT TIDAK DITEMUKAN'); ?>
    ...
    <?php endif; ?>
                                    ...
                                    <td class="px-6 py-5 whitespace-nowrap text-center">
                                        <?php if($p->foto_identitas): ?>
                                            <a href="<?php echo e(asset('storage/' . $p->foto_identitas)); ?>" target="_blank" class="relative inline-block group">
                                                <img src="<?php echo e(asset('storage/' . $p->foto_identitas)); ?>" 
                                    ...
                                    <td class="px-6 py-5 whitespace-nowrap text-center">
                                        ...
                                        <div class="text-[9px] text-gray-400 font-bold uppercase"><?php echo e($p->lama_sewa); ?> Hari Sewa</div>
                                    </td>
                                    ...
                                    <td class="px-6 py-5 whitespace-nowrap text-center">
                                        ...
                                        ?>
                                        <span class="px-3 py-1 inline-flex text-[10px] leading-5 font-black rounded-full border shadow-sm <?php echo e($currentClass); ?> uppercase">
                                            <?php echo e($p->status); ?>
