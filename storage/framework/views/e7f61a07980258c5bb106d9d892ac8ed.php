        ...
        <div class="relative overflow-hidden bg-slate-900 py-24 sm:py-32">
            ...
            <div class="relative max-w-7xl mx-auto px-6 lg:px-8 text-center">
                ...
                <div class="flex flex-wrap justify-center gap-4">
                    <a href="<?php echo e(route('home')); ?>" class="px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-2xl transition-all shadow-xl shadow-blue-600/20 hover:-translate-y-1">Mulai Perjalanan</a>
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8 py-24">
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="space-y-12">
                        ...
                        <div class="relative group">
                            ...
                            <?php if(Auth::check() && Auth::user()->role == 'admin'): ?>
                                <div class="mt-4 flex gap-2">
                                    <a href="<?php echo e(route('admin.tentang_kami.edit', $item->id)); ?>" class="text-xs font-bold text-blue-600 hover:underline">EDIT SECTION</a>
                                    <form action="<?php echo e(route('admin.tentang_kami.destroy', $item->id)); ?>" method="POST" class="inline">
                    ...
                    <?php if(Auth::check() && Auth::user()->role == 'admin'): ?>
                        <a href="<?php echo e(route('admin.tentang_kami.create')); ?>" class="inline-flex items-center gap-3 px-6 py-3 bg-slate-900 text-white rounded-xl font-bold text-sm hover:bg-blue-600 transition-colors">
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="bg-blue-600 rounded-[4rem] p-12 md:p-20 text-center relative overflow-hidden shadow-2xl shadow-blue-600/30">
                ...
                <div class="relative z-10">
                    ...
                    <a href="<?php echo e(route('home')); ?>" class="inline-flex items-center gap-4 px-10 py-5 bg-white text-blue-600 font-black rounded-2xl hover:bg-slate-900 hover:text-white transition-all transform hover:scale-105">
                        PESAN SEKARANG
