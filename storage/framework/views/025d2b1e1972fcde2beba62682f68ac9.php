                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gray-900 rounded-2xl p-6 shadow-lg text-white relative overflow-hidden">
                        ...
                        <div class="space-y-3 relative z-10">
                            <a href="<?php echo e(route('mobils.create')); ?>" class="block w-full bg-gray-800 hover:bg-gray-700 border border-gray-700 p-3 rounded-lg flex items-center transition group">
                            ...
                            <a href="<?php echo e(route('admin.transaksi.index')); ?>" class="block w-full bg-gray-800 hover:bg-gray-700 border border-gray-700 p-3 rounded-lg flex items-center transition group">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                        ...
                        <ul class="space-y-3 text-sm text-gray-600">
                            ...
                            <li class="flex justify-between">
                                ...
                                <span class="font-mono"><?php echo e(phpversion()); ?></span>
                            </li>
                            <li class="flex justify-between">
                                <span>Laravel</span>
