                ...
                <div class="group bg-white rounded-3xl border border-gray-100 shadow-lg hover:shadow-2xl transition-all duration-300 relative overflow-hidden flex flex-col">
                    ...
                    <div class="p-8 flex-1 flex flex-col">
                        ...
                        <div class="mb-4 p-3 bg-blue-50 rounded-lg border border-blue-100">
                            <p class="text-sm font-bold text-red-600 mb-1"><i class="fa-solid fa-location-dot mr-1"></i> Lokasi: <?php echo e($mobil->branch->kota ?? 'Tidak Diketahui'); ?></p>
                            <p class="text-sm font-bold text-slate-700"><i class="fa-solid fa-building mr-1"></i> Mitra: <?php echo e($mobil->rental->nama_rental ?? 'FZ Rent'); ?></p>
                        </div>
