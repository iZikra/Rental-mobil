                            ...
                            <div>
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="no_telp_bisnis" value="<?php echo e(old('no_telp_bisnis', $rental->no_telp_bisnis)); ?>" class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 font-semibold focus:ring-blue-500" placeholder="Contoh: 081234567890" required>
