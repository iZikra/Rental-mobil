    ...
    <div class="relative z-10 -mt-32 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
                                ...
                                <div class="flex flex-col space-y-2 text-xs">
                                    ...
                                    <?php else: ?>
                                        <div class="flex items-start gap-2 text-gray-600">
                                            ...
                                            <span class="font-medium truncate max-w-[150px]" title="<?php echo e($t->alamat_jemput ?? $t->alamat_lengkap); ?>"><?php echo e($t->alamat_jemput ?? $t->alamat_lengkap); ?></span>
                                        </div>
                                    <?php endif; ?>
                                    ...
                                    <?php else: ?>
                                        <div class="flex items-start gap-2 text-gray-600">
                                            ...
                                            <span class="font-medium truncate max-w-[150px]" title="<?php echo e($t->alamat_antar ?? $t->alamat_lengkap); ?>"><?php echo e($t->alamat_antar ?? $t->alamat_lengkap); ?></span>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-5 whitespace-nowrap text-center">
                                ...
                                <div class="flex flex-col items-center gap-3">
                                    ...
                                    <div class="flex flex-col gap-2 w-full max-w-[140px]">
                                        ...
                                        <?php if($canChat): ?>
                                            <a href="https://wa.me/6285375285567?text=Halo Admin, saya ingin konfirmasi pesanan ID #<?php echo e($t->id); ?> - <?php echo e($t->mobil->merek); ?> <?php echo e($t->mobil->model); ?>" 
                                               target="_blank" 
                                ...
                                <?php if($canPay && !$t->bukti_bayar): ?>
                                <div id="modal-upload-<?php echo e($t->id); ?>" class="hidden fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                                    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                                        ...
                                        <div class="inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm w-full">
                                            <div class="bg-gradient-to-r from-slate-800 to-slate-900 px-4 py-3 flex justify-between items-center">
                                                ...
                                                <button onclick="document.getElementById('modal-upload-<?php echo e($t->id); ?>').classList.add('hidden')" class="text-gray-400 hover:text-white">
                        ...
                        <tr>
                            <td colspan="5" class="px-6 py-24 text-center">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <a href="<?php echo e(route('pages.order')); ?>" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-8 rounded-xl shadow-lg hover:shadow-blue-500/30 transition transform hover:-translate-y-1">
                                        Sewa Mobil Sekarang
                                    </a>
                                </div>
                            </td>
        ...
        <div class="mt-8 text-center">
            <p class="text-xs text-white/80 font-medium drop-shadow-md">
                &copy; <?php echo e(date('Y')); ?> Rental Mobil Zikrallah. Sistem pembayaran aman dan terpercaya.
            </p>
        </div>
    </div>
