    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12">
            ...
            <div class="glass-card rounded-[2.5rem] p-8 group overflow-hidden relative">
                ...
                <div class="flex items-center gap-5 mb-6">
                    ...
                    <div>
                        ...
                        <h4 class="text-3xl font-black text-slate-900 leading-tight"><?php echo e($branches->count()); ?> <span class="text-sm font-medium text-slate-400">Lokasi</span></h4>
                    </div>
                </div>
            ...
            <div class="glass-card rounded-[2.5rem] p-8 group overflow-hidden relative">
                ...
                <div class="flex items-center gap-5 mb-6">
                    ...
                    <div>
                        ...
                        <h4 class="text-3xl font-black text-slate-900 leading-tight"><?php echo e($branches->pluck('kota')->unique()->count()); ?> <span class="text-sm font-medium text-slate-400">Kota</span></h4>
                    </div>
                </div>
                <div class="h-1.5 w-full bg-slate-100 rounded-full overflow-hidden">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12 animate-entry" style="animation-delay: 0.2s">
            <?php $__empty_1 = true; $__currentLoopData = $branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="branch-card glass-card rounded-[3rem] overflow-hidden flex flex-col group/card" style="animation-delay: <?php echo e(0.1 * ($index + 3)); ?>s">
                    <div class="p-10 flex-1">
                        <div class="flex items-start justify-between mb-8">
                            <div class="flex items-center gap-5">
                                ...
                                <div>
                                    <h3 class="text-2xl font-black text-slate-900 tracking-tight group-hover/card:text-blue-600 transition-colors"><?php echo e($branch->nama_cabang); ?></h3>
                            ...
                            <div class="flex gap-3 relative z-20">
                                <button type="button" onclick='openEditModal(<?php echo json_encode($branch, 15, 512) ?>)' 
                                ...
                                <form action="<?php echo e(route('mitra.cabang.destroy', $branch->id)); ?>" method="POST" onsubmit="return confirm('Hapus cabang ini? Pastikan tidak ada armada yang terdaftar di sini.')">
                        ...
                        <div class="space-y-6">
                            <div class="group/item">
                                ...
                                <div class="p-5 bg-slate-50/50 rounded-[1.5rem] border border-slate-100 group-hover/card:bg-white transition-colors duration-500">
                                    <div class="flex gap-4">
                                        ...
                                        <p class="text-sm font-semibold text-slate-700 leading-relaxed pt-1"><?php echo e($branch->alamat_lengkap); ?></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $branch->nomor_telepon_cabang)); ?>" 
                                       target="_blank"
                                       class="flex items-center gap-3 p-4 bg-emerald-50/50 rounded-2xl border border-emerald-100/50 group/wa hover:bg-emerald-500 hover:border-emerald-500 transition-all duration-300">
                                        ...
                                        <span class="text-sm font-black text-slate-700 group-hover/wa:text-white transition-colors tracking-wide"><?php echo e($branch->nomor_telepon_cabang); ?></span>
                                    </a>
                                </div>
                                <div>
                    ...
                    <div class="px-10 py-6 bg-slate-50/80 border-t border-slate-100 flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <span class="text-[11px] text-slate-500 font-bold uppercase tracking-[0.15em]">Registered Since <?php echo e($branch->created_at->format('M Y')); ?></span>
                        </div>
                        <a href="https://maps.google.com/?q=<?php echo e(urlencode($branch->alamat_lengkap . ', ' . $branch->kota)); ?>"
                           target="_blank"
...
<div id="modalCabang" class="modal-overlay" onclick="if(event.target===this) closeModal()">
    <div class="modal-box bg-white rounded-[3rem] shadow-2xl w-full max-w-xl border border-white/20">
        ...
        <form id="formCabang" action="<?php echo e(route('mitra.cabang.store')); ?>" method="POST" class="p-12 space-y-8 rounded-b-[3rem]">
            <?php echo csrf_field(); ?>
...
<script>
    ...
    function openAddModal() {
        ...
        form.action = "<?php echo e(route('mitra.cabang.store')); ?>";
...
<?php /**PATH C:\Users\GF 63\rental-mobil\resources\views\mitra\cabang\index.blade.php ENDPATH**/ ?>