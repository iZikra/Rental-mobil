...
<body class="bg-gray-100 p-6 md:p-10">
    ...
    <div class="max-w-2xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden p-8 border border-gray-200">
            ...
            <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <div class="text-center md:text-right mt-4 md:mt-0">
                    ...
                    <p class="text-sm font-bold text-red-500">
                        <?php echo e(\Carbon\Carbon::parse($transaksi->created_at)->addHours(24)->format('d M Y H:i')); ?> WIB
                    </p>
        ...
        <div class="mt-8 text-center no-print space-x-4">
            ...
            <a href="<?php echo e(route('riwayat.index')); ?>" class="ml-4 text-gray-500 hover:text-gray-800 font-medium underline transition">
                Kembali ke Riwayat
            </a>
        </div>
    </div>
...
</html><?php /**PATH C:\Users\GF 63\rental-mobil\resources\views\pages\invoice.blade.php ENDPATH**/ ?>