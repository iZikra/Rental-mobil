    ...
    <div id="list-mobil" class="py-24 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-10 rounded-3xl border border-slate-200/70 bg-white shadow-[0_18px_60px_-30px_rgba(15,23,42,0.35)] overflow-hidden">
                ...
                <div class="px-6 sm:px-8 py-6">
                    <form action="<?php echo e(url()->current()); ?>" method="GET" class="grid grid-cols-1 lg:grid-cols-3 gap-5 items-end">
            ...
            .then(res => {
                ...
                if (res.status === 'success' && res.data.length > 0) {
                    ...
                    res.data.forEach(item => {
                        const card = `
                            <div class="bg-white p-3 rounded-xl shadow-sm border border-blue-100 flex gap-3 animate-fade-in-up">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-[11px] text-blue-700 font-medium leading-tight mb-2 line-clamp-2 italic">"${item.reason}"</p>
                                    <a href="/car/${item.slug}" class="text-[10px] bg-blue-600 text-white px-3 py-1 rounded-full font-bold hover:bg-blue-700 transition">Detail & Pesan</a>
                                </div>
                            </div>
                        `;
