<section>
    <header class="mb-8">
        ...
        <p class="mt-2 text-sm text-slate-500 font-medium">
            <?php echo e(__("Perbarui informasi profil akun dan alamat email Anda untuk menjaga keakuratan data.")); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-label','data' => ['for' => 'name','value' => __('Full Name'),'class' => 'text-xs font-black uppercase tracking-widest text-slate-400 ml-1']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['for' => 'name','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Full Name')),'class' => 'text-xs font-black uppercase tracking-widest text-slate-400 ml-1']); ?>
...
<?php endif; ?>
        ...
        <div class="space-y-2">
            <?php if (isset($component)) { $__componentOriginale3da9d84bb64e4bc2eeebaafabfb2581 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale3da9d84bb64e4bc2eeebaafabfb2581 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-label','data' => ['for' => 'email','value' => __('Email Address'),'class' => 'text-xs font-black uppercase tracking-widest text-slate-400 ml-1']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['for' => 'email','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Email Address')),'class' => 'text-xs font-black uppercase tracking-widest text-slate-400 ml-1']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale3da9d84bb64e4bc2eeebaafabfb2581)): ?>
<?php $attributes = $__attributesOriginale3da9d84bb64e4bc2eeebaafabfb2581; ?>
...
<?php endif; ?>
        ...
        <div class="flex items-center gap-4 pt-4">
            ...
            <?php if(session('status') === 'profile-updated'): ?>
                ...
                ><i class="fa-solid fa-circle-check mr-1"></i> <?php echo e(__('Updated successfully.')); ?></p>
            <?php endif; ?>
        </div>
    </form>
</section>
<?php /**PATH C:\Users\GF 63\rental-mobil\resources\views/profile/partials/update-profile-information-form.blade.php ENDPATH**/ ?>