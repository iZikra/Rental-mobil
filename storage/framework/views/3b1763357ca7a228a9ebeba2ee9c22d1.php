            ...
            <div class="bg-gray-50 rounded-lg p-4 border border-gray-100 mb-4">
                <div class="grid grid-cols-2 gap-4 relative">
                    ...
                    <div>
                        ...
                        <p class="text-tokopedia text-xs mt-1 font-medium">📍 <?php echo e($transaksi->lokasi_ambil == 'kantor' ? 'Kantor Rental' : ($transaksi->alamat_jemput ?? 'Diantar ke Lokasi')); ?></p>
                    </div>
                    ...
                    <div class="pl-4">
                        ...
                        <p class="text-tokopedia text-xs mt-1 font-medium">📍 <?php echo e($transaksi->lokasi_kembali == 'kantor' ? 'Kantor Rental' : ($transaksi->alamat_antar ?? 'Dijemput di Lokasi')); ?></p>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\Users\GF 63\rental-mobil\resources\views\pages\tiket.blade.php ENDPATH**/ ?>