                    ...
                    <tbody>
                        ...
                        <tr class="border-b">
                            ...
                            <td class="px-6 py-4">
                                ...
                                <?php elseif($rental->status == 'inactive'): ?>
                                    <span class="px-3 py-1 bg-amber-100 text-amber-700 rounded-full text-xs font-bold">Belum Aktif</span>
                                <?php elseif($rental->status == 'banned'): ?>
                                    <span class="px-3 py-1 bg-rose-100 text-rose-700 rounded-full text-xs font-bold">Banned</span>
                                <?php else: ?>
                                    <span class="px-3 py-1 bg-gray-100 text-gray-600 rounded-full text-xs font-bold"><?php echo e($rental->status); ?></span>
                                <?php endif; ?>
                            </td>
                            <td class="px-6 py-4 text-center">
                                <?php if($rental->status == 'inactive'): ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\GF 63\rental-mobil\resources\views\admin\rentals\index.blade.php ENDPATH**/ ?>