        ...
        <div class="w-full p-6 sm:p-10 lg:p-12 flex flex-col justify-center relative bg-white custom-scrollbar overflow-y-auto max-h-[90vh] lg:max-h-none">
            ...
            <div class="mb-8 text-center lg:text-left mt-4 lg:mt-0">
                ...
                <p class="text-slate-500 text-sm mt-2 font-medium">
                    Sudah memiliki akun? 
                    <a href="<?php echo e(route('login')); ?>" class="text-blue-600 hover:text-blue-800 font-bold hover:underline ml-1">Masuk di sini</a>
                </p>
            </div>
            ...
            <form method="POST" action="<?php echo e(route('register')); ?>" class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
                <?php echo csrf_field(); ?>
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative group">
                        ...
                        <input type="text" name="no_hp" required
                               class="w-full pl-11 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl text-slate-800 text-sm font-semibold outline-none transition-all focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10"
                               placeholder="Contoh: 081234..." value="<?php echo e(old('no_hp')); ?>">
                    </div>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative group">
                        ...
                        <input type="text" name="tempat_lahir" required
                               class="w-full pl-11 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl text-slate-800 text-sm font-semibold outline-none transition-all focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10"
                               placeholder="Kota Lahir" value="<?php echo e(old('tempat_lahir')); ?>">
                    </div>
                </div>
...
<?php /**PATH C:\Users\GF 63\rental-mobil\resources\views/auth/register.blade.php ENDPATH**/ ?>