        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
                <div>
                    ...
                    <p class="text-sm text-gray-500">Total <?php echo e($mobils->count()); ?> unit kendaraan terdaftar.</p>
                </div>
                
                <div class="flex gap-2">
                    <a href="<?php echo e(route('mobils.create')); ?>" class="inline-flex items-center px-4 py-2 bg-red-600 border border-transparent rounded-lg font-semibold text-xs text-white uppercase tracking-widest hover:bg-red-700 active:bg-red-900 focus:outline-none focus:border-red-900 focus:ring ring-red-300 disabled:opacity-25 transition ease-in-out duration-150 shadow-lg transform hover:scale-105">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-lg transition duration-300 flex flex-col group">
                    ...
                    <div class="relative h-48 bg-gray-100 overflow-hidden">
                        <?php if($mobil->gambar): ?>
                            <img src="<?php echo e(asset('img/' . $mobil->gambar)); ?>" alt="<?php echo e($mobil->merk); ?>" class="w-full h-full object-cover group-hover:scale-110 transition duration-500">
                        <?php else: ?>
                    ...
                    <div class="p-5 flex-1">
                        <div class="flex justify-between items-start mb-2">
                            <div>
                                <h3 class="text-lg font-bold text-gray-800"><?php echo e($mobil->merk); ?> <?php echo e($mobil->model); ?></h3>
                                <p class="text-sm text-gray-500">Tahun <?php echo e($mobil->tahun); ?></p>
                            </div>
                            <div class="text-right">
                                <p class="text-red-600 font-bold text-lg">Rp <?php echo e(number_format($mobil->harga_sewa)); ?></p>
                        ...
                        <div class="border-t border-gray-100 my-4 pt-4 flex justify-between text-sm text-gray-600">
                            <span class="flex items-center gap-1">
                                ...
                                <?php echo e($mobil->bahan_bakar ?? 'Bensin'); ?>
                    ...
                    <div class="bg-gray-50 px-5 py-3 border-t border-gray-100 flex justify-between items-center">
                        <a href="<?php echo e(route('mobils.edit', $mobil->id)); ?>" class="text-indigo-600 hover:text-indigo-900 text-sm font-medium flex items-center gap-1 hover:underline">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                            Edit Data
                        </a>
                        
                        <form action="<?php echo e(route('mobils.destroy', $mobil->id)); ?>" method="POST" onsubmit="return confirm('Yakin ingin menghapus mobil ini?');">
                            <?php echo csrf_field(); ?>
            ...
            <div class="text-center py-16 bg-white rounded-xl border-dashed border-2 border-gray-300 mt-6">
                ...
                <div class="mt-6">
                    <a href="<?php echo e(route('mobils.create')); ?>" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
...
<?php endif; ?><?php /**PATH C:\Users\GF 63\rental-mobil\resources\views\admin\mobil\index.blade.php ENDPATH**/ ?>